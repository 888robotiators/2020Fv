...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        display = Shuffleboard.getTab("SmartDashboard");
    ...
    public void autonomousPeriodic() {
        ...
        //auto.periodic();
        // if (guidence.goToWaypoint(map.get("TwoFootTestPoint"), -.5)) {
        //     done = true;
        // }
        ...
        if (done) {
            if (shooter.getRPMs() > 2700 && counter > 50 * 5) { //display.add("Delay", 0).getEntry().getDouble(0.0) * 50) {
                index.loadShooter();
            }
        }
